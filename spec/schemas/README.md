...
| `decision-record-0.1.0.json` | An operation was classified and acted upon |
| `attempt-record-0.1.0.json` | The enforcement point refused without classifying |
| `outcome-record-0.1.0.json` | What happened when an approved Tier 3 executed |
